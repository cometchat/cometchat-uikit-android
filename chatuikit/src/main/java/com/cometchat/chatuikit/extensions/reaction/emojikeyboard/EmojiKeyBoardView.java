...
public class EmojiKeyBoardView extends MaterialCardView {
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TypedArray typedArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatEmojiKeyBoardView, defStyleAttr, defStyleRes);
    ...
    private void extractAttributesAndApplyDefaults(TypedArray typedArray) {
        try {
            ...
            setSelectedCategoryIconTint(typedArray.getColor(R.styleable.CometChatEmojiKeyBoardView_cometchatEmojiKeyboardSelectedCategoryIconTint, 0));
            setSelectedCategoryBackgroundColor(typedArray.getColor(R.styleable.CometChatEmojiKeyBoardView_cometchatEmojiKeyboardSelectedCategoryBackgroundColor, CometChatTheme.getExtendedPrimaryColor100(getContext())));
            setCategoryTextAppearance(typedArray.getResourceId(R.styleable.CometChatEmojiKeyBoardView_cometchatEmojiKeyboardCategoryTextAppearance, 0));
