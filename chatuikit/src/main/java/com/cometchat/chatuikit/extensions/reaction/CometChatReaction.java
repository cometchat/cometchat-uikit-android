...
public class CometChatReaction extends MaterialCardView {
     ...
     */
    public View buildReactionView(@NonNull String emoji, int count, boolean isReactedByMe, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener) {
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        directAttributes = styleResId != 0 ? getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatReaction, defStyleAttr, styleResId) : null;
    ...
    private void extractAttributesAndApplyDefaults(TypedArray typedArray) {
        ...
        try {
            ...
            activeReactionStrokeColor = typedArray.getColor(R.styleable.CometChatReaction_cometchatActiveReactionStrokeColor, activeReactionStrokeColor);
            activeReactionBackgroundColor = typedArray.getColor(R.styleable.CometChatReaction_cometchatActiveReactionBackgroundColor, activeReactionBackgroundColor);
            reactionEmojiTextAppearance = typedArray.getResourceId(R.styleable.CometChatReaction_cometchatReactionEmojiTextAppearance, reactionEmojiTextAppearance);
            reactionCountTextAppearance = typedArray.getResourceId(R.styleable.CometChatReaction_cometchatReactionCountTextAppearance, reactionCountTextAppearance);
            ...
            reactionCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CometChatReaction_cometchatReactionCornerRadius, reactionCornerRadius);
            ...
            activeReactionStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CometChatReaction_cometchatActiveReactionStrokeWidth, activeReactionStrokeWidth);
