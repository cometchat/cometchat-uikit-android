...
public class CometChatAudioBubble extends MaterialCardView {
    ...
    private void inflateAndInitializeView(AttributeSet attributeSet, int defStyleAttr) {
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, getContext().getResources().getDimensionPixelSize(R.dimen.cometchat_50dp));
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray finalTypedArray = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatAudioBubble, defStyleAttr, styleResId);
    ...
    private void setAudioWaveColor(@ColorInt int color) {
        audioWaveAnimation.addValueCallback(new KeyPath("**"), // Target the layer for color change
                LottieProperty.COLOR_FILTER, new LottieValueCallback<>(new PorterDuffColorFilter(color, PorterDuff.Mode.SRC_ATOP)));
    }
