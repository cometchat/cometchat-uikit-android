...
public class SingleSelectElement extends BaseInputElement<String> {
    private static final String TAG = SingleSelectElement.class.getSimpleName();

    private String label;
    private List<OptionElement> optionElements;

    private SingleSelectElement() {
        super(UIKitConstants.UIElementsType.UI_ELEMENT_SINGLE_SELECT, null, null);
    }

    public SingleSelectElement(String elementId, String label, List<OptionElement> optionElements, String defaultValue) {
        super(UIKitConstants.UIElementsType.UI_ELEMENT_SINGLE_SELECT, elementId, defaultValue);
        setLabel(label);
    ...
    public static SingleSelectElement fromJson(JSONObject json) {
        SingleSelectElement radioButtonElement = new SingleSelectElement();
        if (json != null) {
            try {
