...
public class CometChatBadge extends MaterialCardView {
    ...
    private void inflateAndInitializeView(AttributeSet attrs, int defStyleAttr) {
        ...
        tvMessageCount.setPadding(getResources().getDimensionPixelSize(R.dimen.cometchat_4dp), getResources().getDimensionPixelSize(R.dimen.cometchat_2dp), getResources().getDimensionPixelSize(R.dimen.cometchat_4dp), getResources().getDimensionPixelSize(R.dimen.cometchat_2dp));
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        directAttributes = styleResId != 0 ? getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatBadge, defStyleAttr, styleResId) : null;
