...
/**
 * IncomingAudioHelper class is used to provide audio tone or ringtone when a
 * there is a incoming call. It provides various method which can set the
 * ringtone or vibrate on incoming call
 *
 * <p>
...
public class IncomingAudioManager {
    private static final String TAG = IncomingAudioManager.class.getSimpleName();
    ...
    /**
     * This method the start the ringtones which passed in parameter and also
     * vibrate the phone on incoming call is vibrate parameter passed is true.
     *
     * @param uri     is object of Uri, It is a path of ringtone.
     * @param vibrate is a boolean which checks if the method needs to enable vibrate
     *                for incoming call or not.
     */
    ...
    /**
     * This method stops the ringtone and cancels vibration.
     */
    public void stop() {
        if (player != null) {
    ...
    /**
     * This method is used to check the vibration mode for different android
     * versions.
     *
     * @param context
     * @param player
