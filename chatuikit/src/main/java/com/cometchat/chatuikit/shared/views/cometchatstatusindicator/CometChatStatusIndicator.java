...
public class CometChatStatusIndicator extends MaterialCardView {
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        directAttributes = styleResId != 0 ? getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatStatusIndicator, defStyleAttr, styleResId) : null;
    ...
    private void extractAttributesAndApplyDefaults(TypedArray typedArray) {
        ...
        try {
            ...
            statusIndicatorStrokeColor = typedArray.getColor(R.styleable.CometChatStatusIndicator_cometchatStatusIndicatorStrokeColor, CometChatTheme.getBackgroundColor1(getContext()));
            statusIndicatorBackgroundColor = typedArray.getColor(R.styleable.CometChatStatusIndicator_cometchatStatusIndicatorBackgroundColor, CometChatTheme.getSuccessColor(getContext()));
            statusIndicatorStrokeWidth = typedArray.getDimension(R.styleable.CometChatStatusIndicator_cometchatStatusIndicatorStrokeWidth, statusIndicatorStrokeWidth);
            statusIndicatorCornerRadius = typedArray.getDimension(R.styleable.CometChatStatusIndicator_cometchatStatusIndicatorCornerRadius, statusIndicatorCornerRadius);
