package com.cometchat.chatuikit.shared.views.cometchatmediarecorder;
...
public class CometChatMediaRecorder extends MaterialCardView {
    ...
    private void extractAttributesAndApplyDefaults(TypedArray typedArray) {
        ...
        try {
            ...
            recordingIconBackgroundColor = typedArray.getColor(R.styleable.CometChatMediaRecorder_cometchatMediaRecorderRecordingIconBackgroundColor, 0);
            ...
            deleteIconStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CometChatMediaRecorder_cometchatMediaRecorderDeleteIconStrokeWidth, 0);
            ...
            restartIconStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CometChatMediaRecorder_cometchatMediaRecorderRestartIconStrokeWidth, 0);
            ...
            outgoingMessageBubbleStyle = typedArray.getResourceId(R.styleable.CometChatMediaRecorder_cometchatMediaRecorderOutgoingMessageBubbleStyle, 0);
    ...
    public void setOutgoingMessageBubbleStyle(@StyleRes int messageBubbleStyle) {
        if (messageBubbleStyle != 0) {
            ...
            try (TypedArray typedArray = getContext().obtainStyledAttributes(messageBubbleStyle, R.styleable.CometChatMessageBubble)) {
                ...
                messageBubbleCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CometChatMessageBubble_cometchatMessageBubbleCornerRadius, 0);
    ...
    public void setOutgoingAudioBubbleStyle(@StyleRes int style) {
        try (TypedArray typedArray = getContext().obtainStyledAttributes(style, R.styleable.CometChatAudioBubble)) {
            messageBubbleBackgroundColor = typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleBackgroundColor, messageBubbleBackgroundColor);
            messageBubbleCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleCornerRadius, messageBubbleCornerRadius);
            messageBubbleStrokeWidth = typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeWidth, messageBubbleStrokeWidth);
            messageBubbleStrokeColor = typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeColor, messageBubbleStrokeColor);
