package com.cometchat.chatuikit.shared.views.cometchatmessagereceipt;
...
public class CometChatMessageReceipt extends AppCompatImageView {
    ...
    private void applyStyleAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        directAttributes = styleResId != 0 ? getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.CometChatMessageReceipt, defStyleAttr, styleResId) : null;
    ...
    private void extractAttributesAndApplyDefaults(TypedArray typedArray) {
        ...
        try {
            ...
            // Colors
            messageReceiptWaitIconTint = typedArray.getColor(R.styleable.CometChatMessageReceipt_cometchatMessageReceiptWaitIconTint, messageReceiptWaitIconTint);
            messageReceiptSentIconTint = typedArray.getColor(R.styleable.CometChatMessageReceipt_cometchatMessageReceiptSentIconTint, messageReceiptSentIconTint);
            messageReceiptDeliveredIconTint = typedArray.getColor(R.styleable.CometChatMessageReceipt_cometchatMessageReceiptDeliveredIconTint, messageReceiptDeliveredIconTint);
            messageReceiptReadIconTint = typedArray.getColor(R.styleable.CometChatMessageReceipt_cometchatMessageReceiptReadIconTint, messageReceiptReadIconTint);
            messageReceiptErrorIconTint = typedArray.getColor(R.styleable.CometChatMessageReceipt_cometchatMessageReceiptErrorIconTint, messageReceiptErrorIconTint);
