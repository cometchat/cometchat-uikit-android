package com.cometchat.chatuikit.ai.aismartreplies.view;
...
import com.cometchat.chatuikit.databinding.CometchatAiSmartRepliesRowBinding;

import java.util.ArrayList;
import java.util.List;

public class AISmartRepliesAdapter extends RecyclerView.Adapter<AISmartRepliesAdapter.ViewHolder> {
    private static final String TAG = AISmartRepliesAdapter.class.getSimpleName();
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        CometchatAiSmartRepliesRowBinding binding = CometchatAiSmartRepliesRowBinding.inflate(
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private final CometchatAiSmartRepliesRowBinding binding;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            binding = CometchatAiSmartRepliesRowBinding.bind(itemView);
        }
