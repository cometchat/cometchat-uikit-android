...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickyHeaderAdapter<MessageAdapter.DateItemHolder> {
    ...
    public int getItemViewTypes(int position) {
        ...
        if (baseMessage.getCategory().equals(CometChatConstants.CATEGORY_ACTION) ||
            ...
            if (!UIKitConstants.MessageListAlignment.LEFT_ALIGNED.equals(listAlignment)) {
                if (baseMessage.getSender() != null && CometChatUIKit.getLoggedInUser() != null && baseMessage.getSender().getUid().equals(CometChatUIKit.getLoggedInUser().getUid())) {
                    type = RIGHT_MESSAGE;
                } else {
                    type = LEFT_MESSAGE;
                }
    ...
    public void onBindHeaderViewHolder(MessageAdapter.DateItemHolder var1, int var2, long var3) {
        ...
        if (baseMessageList.size() > var2) {
            ...
            var1.txtMessageDate.setPadding(context.getResources().getDimensionPixelSize(R.dimen.cometchat_padding_2), context.getResources().getDimensionPixelSize(R.dimen.cometchat_padding_1), context.getResources().getDimensionPixelSize(R.dimen.cometchat_padding_2), context.getResources().getDimensionPixelSize(R.dimen.cometchat_padding_1));
        ...
        public void bindBubble(BaseMessage baseMessage, int position) {
            ...
            if (template != null) {
                if (template.getBubbleView() != null) {
                    ...
                    applyBubbleStyle(baseMessage, isIncoming, alignment, cometchatMessageBubble, showReadReceipt, hideName, headerView, statusInfoView, threadView, leadingView);
                    ...
                    if (template.getFooterView() != null) {
                        ...
                        adjustFooterAndContentView(footerView, contentView, cometchatMessageBubble, baseMessage, isIncoming ? incomingMessageBubbleReactionStyle : outgoingMessageBubbleReactionStyle, cometchatUIKitReactionActionEvents);
                    }
                        ...
                        if (threadView != null) {
                            threadView.setOnClickListener(view1 -> {
                                if (threadReplyClick != null) {
                                    CometChatMessageTemplate clonedTemplate = clonedTemplate(template, baseMessage, alignment, position, this, time, hideName, showReadReceipt);
                ...
                parent.setOnLongClickListener(view -> {
                    ...
                    if (options != null && !options.isEmpty()) {
                        CometChatMessageTemplate clonedTemplate = clonedTemplate(template, baseMessage, alignment, position, this, time, hideName, showReadReceipt);
                        onMessageLongClick.onLongClick(options, baseMessage, clonedTemplate, getMessageBubble(baseMessage, template, alignment, this, position, time, hideName, showReadReceipt));
                    }
                    return true;
                });
            }
        ...
        public void bindBubble(BaseMessage baseMessage, int position) {
            ...
            if (template != null) {
                ...
                parent.setOnLongClickListener(view -> {
                    List<CometChatMessageOption> options = template.getOptions(context, baseMessage, group);
                    if (options != null && !options.isEmpty()) {
                        onMessageLongClick.onLongClick(options, baseMessage, template, getMessageBubble(baseMessage, template, alignment, this, position, time, true, false));
                    } else {
    ...
    public void setMessageTemplateHashMap(HashMap<String, CometChatMessageTemplate> messageTemplateHashMap, HashMap<String, Integer> viewTypeHashMap) {
        this.messageTemplateHashMap = messageTemplateHashMap;
     ...
     */
    private void bindHeaderView(View view, boolean showName, String name, String time, boolean showTime, @ColorInt int nameColor, @StyleRes int nameAppearance, @StyleRes int dateStyle) {
     ...
     * @param dateStyle       the style resource for the date appearance.
     */
    private void bindStatusInfoView(View view, boolean showReadReceipt, Receipt receipt, String time, boolean showTime, @StyleRes int receiptStyle, @StyleRes int dateStyle) {
            ...
            if (alignment.equals(UIKitConstants.MessageBubbleAlignment.LEFT)) {
                if (baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_USER)) {
                    if (listAlignment.equals(UIKitConstants.MessageListAlignment.LEFT_ALIGNED)) {
                        MessageBubbleUtils.bindAvatarLeadingView(view, true, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName(), avatarStyle);
                    } else
                        MessageBubbleUtils.bindAvatarLeadingView(view, showLeftBubbleUserAvatar, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName(), avatarStyle);
                } else if (baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_GROUP))
                    MessageBubbleUtils.bindAvatarLeadingView(view, showLeftBubbleGroupAvatar, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName(), avatarStyle);
            } else {
                if (baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_USER))
                    MessageBubbleUtils.bindAvatarLeadingView(view, showLeftBubbleUserAvatar && layoutDirection == View.LAYOUT_DIRECTION_RTL, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName(), avatarStyle);
                else if (baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_GROUP))
                    MessageBubbleUtils.bindAvatarLeadingView(view, showLeftBubbleGroupAvatar && layoutDirection == View.LAYOUT_DIRECTION_RTL, baseMessage.getSender().getAvatar(), baseMessage.getSender().getName(), avatarStyle);
            }
        }
    }
     ...
     */
    private void bindThreadView(View view, BaseMessage baseMessage, String replyMessage, UIKitConstants.MessageBubbleAlignment alignment, @ColorInt int threadReplyTextColor, @StyleRes int threadReplyTextAppearance, @ColorInt int threadReplyIconTint, @DrawableRes int threadReplyIcon) {
        if (view != null && view.getTag() != null && view.getTag().equals(UIKitConstants.ViewTag.INTERNAL_THREAD_VIEW)) {
            MessageBubbleUtils.bindThreadView(view, baseMessage, replyMessage, alignment, threadReplyTextColor, threadReplyTextAppearance, threadReplyIconTint, threadReplyIcon);
        }
    }
     ...
     */
    private void applyBubbleStyle(BaseMessage message, boolean isIncomingMessage, UIKitConstants.MessageBubbleAlignment messageBubbleAlignment, CometChatMessageBubble cometchatMessageBubble, boolean showReadReceipt, boolean hideName, View headerView, View statusInfoView, View threadView, View leadingView) {
            ...
            switch (bubbleId) {
                case UIKitConstants.MessageTemplateId.TEXT:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingTextBubbleBackgroundColor, incomingTextBubbleCornerRadius, incomingTextBubbleStrokeWidth, incomingTextBubbleStrokeColor, incomingTextBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingTextBubbleSenderNameTextColor, incomingTextBubbleSenderNameTextAppearance, incomingTextBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingTextBubbleReceiptStyle, incomingTextBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingTextBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingTextBubbleThreadIndicatorTextColor, incomingTextBubbleThreadIndicatorTextAppearance, incomingTextBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingTextBubbleBackgroundColor, outgoingTextBubbleCornerRadius, outgoingTextBubbleStrokeWidth, outgoingTextBubbleStrokeColor, outgoingTextBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingTextBubbleSenderNameTextColor, outgoingTextBubbleSenderNameTextAppearance, outgoingTextBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingTextBubbleReceiptStyle, outgoingTextBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingTextBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingTextBubbleThreadIndicatorTextColor, outgoingTextBubbleThreadIndicatorTextAppearance, outgoingTextBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.IMAGE:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingImageBubbleBackgroundColor, incomingImageBubbleCornerRadius, incomingImageBubbleStrokeWidth, incomingImageBubbleStrokeColor, incomingImageBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingImageBubbleSenderNameTextColor, incomingImageBubbleSenderNameTextAppearance, incomingImageBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingImageBubbleReceiptStyle, incomingImageBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingImageBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingImageBubbleThreadIndicatorTextColor, incomingImageBubbleThreadIndicatorTextAppearance, incomingImageBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingImageBubbleBackgroundColor, outgoingImageBubbleCornerRadius, outgoingImageBubbleStrokeWidth, outgoingImageBubbleStrokeColor, outgoingImageBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingImageBubbleSenderNameTextColor, outgoingImageBubbleSenderNameTextAppearance, outgoingImageBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingImageBubbleReceiptStyle, outgoingImageBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingImageBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingImageBubbleThreadIndicatorTextColor, outgoingImageBubbleThreadIndicatorTextAppearance, outgoingImageBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.VIDEO:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingVideoBubbleBackgroundColor, incomingVideoBubbleCornerRadius, incomingVideoBubbleStrokeWidth, incomingVideoBubbleStrokeColor, incomingVideoBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingVideoBubbleSenderNameTextColor, incomingVideoBubbleSenderNameTextAppearance, incomingVideoBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingVideoBubbleReceiptStyle, incomingVideoBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingVideoBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingVideoBubbleThreadIndicatorTextColor, incomingVideoBubbleThreadIndicatorTextAppearance, incomingVideoBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingVideoBubbleBackgroundColor, outgoingVideoBubbleCornerRadius, outgoingVideoBubbleStrokeWidth, outgoingVideoBubbleStrokeColor, outgoingVideoBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingVideoBubbleSenderNameTextColor, outgoingVideoBubbleSenderNameTextAppearance, outgoingVideoBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingVideoBubbleReceiptStyle, outgoingVideoBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingVideoBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingVideoBubbleThreadIndicatorTextColor, outgoingVideoBubbleThreadIndicatorTextAppearance, outgoingVideoBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.AUDIO:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingAudioBubbleBackgroundColor, incomingAudioBubbleCornerRadius, incomingAudioBubbleStrokeWidth, incomingAudioBubbleStrokeColor, incomingAudioBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingAudioBubbleSenderNameTextColor, incomingAudioBubbleSenderNameTextAppearance, incomingAudioBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingAudioBubbleReceiptStyle, incomingAudioBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingAudioBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingAudioBubbleThreadIndicatorTextColor, incomingAudioBubbleThreadIndicatorTextAppearance, incomingAudioBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingAudioBubbleBackgroundColor, outgoingAudioBubbleCornerRadius, outgoingAudioBubbleStrokeWidth, outgoingAudioBubbleStrokeColor, outgoingAudioBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingAudioBubbleSenderNameTextColor, outgoingAudioBubbleSenderNameTextAppearance, outgoingAudioBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingAudioBubbleReceiptStyle, outgoingAudioBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingAudioBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingAudioBubbleThreadIndicatorTextColor, outgoingAudioBubbleThreadIndicatorTextAppearance, outgoingAudioBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.FILE:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingFileBubbleBackgroundColor, incomingFileBubbleCornerRadius, incomingFileBubbleStrokeWidth, incomingFileBubbleStrokeColor, incomingFileBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingFileBubbleSenderNameTextColor, incomingFileBubbleSenderNameTextAppearance, incomingFileBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingFileBubbleReceiptStyle, incomingFileBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingFileBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingFileBubbleThreadIndicatorTextColor, incomingFileBubbleThreadIndicatorTextAppearance, incomingFileBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingFileBubbleBackgroundColor, outgoingFileBubbleCornerRadius, outgoingFileBubbleStrokeWidth, outgoingFileBubbleStrokeColor, outgoingFileBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingFileBubbleSenderNameTextColor, outgoingFileBubbleSenderNameTextAppearance, outgoingFileBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingFileBubbleReceiptStyle, outgoingFileBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingFileBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingFileBubbleThreadIndicatorTextColor, outgoingFileBubbleThreadIndicatorTextAppearance, outgoingFileBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.FORM:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingFormBubbleBackgroundColor, incomingFormBubbleCornerRadius, incomingFormBubbleStrokeWidth, incomingFormBubbleStrokeColor, incomingFormBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingFormBubbleSenderNameTextColor, incomingFormBubbleSenderNameTextAppearance, incomingFormBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingFormBubbleReceiptStyle, incomingFormBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingFormBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingFormBubbleThreadIndicatorTextColor, incomingFormBubbleThreadIndicatorTextAppearance, incomingFormBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingFormBubbleBackgroundColor, outgoingFormBubbleCornerRadius, outgoingFormBubbleStrokeWidth, outgoingFormBubbleStrokeColor, outgoingFormBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingFormBubbleSenderNameTextColor, outgoingFormBubbleSenderNameTextAppearance, outgoingFormBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingFormBubbleReceiptStyle, outgoingFormBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingFormBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingFormBubbleThreadIndicatorTextColor, outgoingFormBubbleThreadIndicatorTextAppearance, outgoingFormBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageTemplateId.SCHEDULER:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingSchedulerBubbleBackgroundColor, incomingSchedulerBubbleCornerRadius, incomingSchedulerBubbleStrokeWidth, incomingSchedulerBubbleStrokeColor, incomingSchedulerBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingSchedulerBubbleSenderNameTextColor, incomingSchedulerBubbleSenderNameTextAppearance, incomingSchedulerBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingSchedulerBubbleReceiptStyle, incomingSchedulerBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingSchedulerBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingSchedulerBubbleThreadIndicatorTextColor, incomingSchedulerBubbleThreadIndicatorTextAppearance, incomingSchedulerBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingSchedulerBubbleBackgroundColor, outgoingSchedulerBubbleCornerRadius, outgoingSchedulerBubbleStrokeWidth, outgoingSchedulerBubbleStrokeColor, outgoingSchedulerBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingSchedulerBubbleSenderNameTextColor, outgoingSchedulerBubbleSenderNameTextAppearance, outgoingSchedulerBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingSchedulerBubbleReceiptStyle, outgoingSchedulerBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingSchedulerBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingSchedulerBubbleThreadIndicatorTextColor, outgoingSchedulerBubbleThreadIndicatorTextAppearance, outgoingSchedulerBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageCategory.CUSTOM + "_" + ExtensionConstants.ExtensionType.EXTENSION_POLL:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingPollBubbleBackgroundColor, incomingPollBubbleCornerRadius, incomingPollBubbleStrokeWidth, incomingPollBubbleStrokeColor, incomingPollBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingPollBubbleSenderNameTextColor, incomingSchedulerBubbleSenderNameTextAppearance, incomingPollBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingPollBubbleReceiptStyle, incomingPollBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingPollBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingPollBubbleThreadIndicatorTextColor, incomingPollBubbleThreadIndicatorTextAppearance, incomingPollBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingPollBubbleBackgroundColor, outgoingPollBubbleCornerRadius, outgoingPollBubbleStrokeWidth, outgoingPollBubbleStrokeColor, outgoingPollBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingPollBubbleSenderNameTextColor, outgoingSchedulerBubbleSenderNameTextAppearance, outgoingPollBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingPollBubbleReceiptStyle, outgoingPollBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingPollBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingPollBubbleThreadIndicatorTextColor, outgoingPollBubbleThreadIndicatorTextAppearance, outgoingPollBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageCategory.CUSTOM + "_" + ExtensionConstants.ExtensionType.STICKER:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingStickerBubbleBackgroundColor, incomingStickerBubbleCornerRadius, incomingStickerBubbleStrokeWidth, incomingStickerBubbleStrokeColor, incomingStickerBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingStickerBubbleSenderNameTextColor, incomingSchedulerBubbleSenderNameTextAppearance, incomingStickerBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingStickerBubbleReceiptStyle, incomingStickerBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingStickerBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingStickerBubbleThreadIndicatorTextColor, incomingStickerBubbleThreadIndicatorTextAppearance, incomingStickerBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingStickerBubbleBackgroundColor, outgoingStickerBubbleCornerRadius, outgoingStickerBubbleStrokeWidth, outgoingStickerBubbleStrokeColor, outgoingStickerBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingStickerBubbleSenderNameTextColor, outgoingSchedulerBubbleSenderNameTextAppearance, outgoingStickerBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingStickerBubbleReceiptStyle, outgoingStickerBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingStickerBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingStickerBubbleThreadIndicatorTextColor, outgoingStickerBubbleThreadIndicatorTextAppearance, outgoingStickerBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageCategory.CUSTOM + "_" + ExtensionConstants.ExtensionType.DOCUMENT:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingCollaborativeBubbleBackgroundColor, incomingCollaborativeBubbleCornerRadius, incomingCollaborativeBubbleStrokeWidth, incomingCollaborativeBubbleStrokeColor, incomingCollaborativeBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingCollaborativeBubbleSenderNameTextColor, incomingSchedulerBubbleSenderNameTextAppearance, incomingCollaborativeBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), incomingCollaborativeBubbleReceiptStyle, incomingCollaborativeBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingCollaborativeBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingCollaborativeBubbleThreadIndicatorTextColor, incomingCollaborativeBubbleThreadIndicatorTextAppearance, incomingCollaborativeBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingCollaborativeBubbleBackgroundColor, outgoingCollaborativeBubbleCornerRadius, outgoingCollaborativeBubbleStrokeWidth, outgoingCollaborativeBubbleStrokeColor, outgoingCollaborativeBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingCollaborativeBubbleSenderNameTextColor, outgoingSchedulerBubbleSenderNameTextAppearance, outgoingCollaborativeBubbleDateStyle);
                        bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), outgoingCollaborativeBubbleReceiptStyle, outgoingCollaborativeBubbleDateStyle);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingCollaborativeBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingCollaborativeBubbleThreadIndicatorTextColor, outgoingCollaborativeBubbleThreadIndicatorTextAppearance, outgoingCollaborativeBubbleThreadIndicatorIconTint, 0);
                    }
                    break;
                case UIKitConstants.MessageCategory.CUSTOM + "_" + UIKitConstants.MessageType.MEETING:
                    if (isIncomingMessage) {
                        setMessageBubbleStyle(incomingMeetCallBubbleBackgroundColor, incomingMeetCallBubbleCornerRadius, incomingMeetCallBubbleStrokeWidth, incomingMeetCallBubbleStrokeColor, incomingMeetCallBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingMeetCallBubbleSenderNameTextColor, incomingSchedulerBubbleSenderNameTextAppearance, 0);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, incomingMeetCallBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, incomingMeetCallBubbleThreadIndicatorTextColor, incomingMeetCallBubbleThreadIndicatorTextAppearance, incomingMeetCallBubbleThreadIndicatorIconTint, 0);
                    } else {
                        setMessageBubbleStyle(outgoingMeetCallBubbleBackgroundColor, outgoingMeetCallBubbleCornerRadius, outgoingMeetCallBubbleStrokeWidth, outgoingMeetCallBubbleStrokeColor, outgoingMeetCallBubbleBackgroundDrawable, cometchatMessageBubble);
                        bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingMeetCallBubbleSenderNameTextColor, outgoingSchedulerBubbleSenderNameTextAppearance, 0);
                        bindLeadingView(leadingView, message, messageBubbleAlignment, outgoingMeetCallBubbleAvatarStyle);
                        bindThreadView(threadView, message, null, messageBubbleAlignment, outgoingMeetCallBubbleThreadIndicatorTextColor, outgoingMeetCallBubbleThreadIndicatorTextAppearance, outgoingMeetCallBubbleThreadIndicatorIconTint, 0);
                    }
                default:
                    ...
                    bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), isIncomingMessage ? incomingMessageBubbleSenderNameTextColor : outgoingMessageBubbleSenderNameTextColor, isIncomingMessage ? incomingMessageBubbleSenderNameTextAppearance : outgoingMessageBubbleSenderNameTextAppearance, isIncomingMessage ? incomingMessageBubbleDateStyle : outgoingMessageBubbleDateStyle);
                    bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), isIncomingMessage ? incomingMessageBubbleReceiptStyle : outgoingMessageBubbleReceiptStyle, isIncomingMessage ? incomingMessageBubbleDateStyle : outgoingMessageBubbleDateStyle);
                    bindLeadingView(leadingView, message, messageBubbleAlignment, isIncomingMessage ? incomingMessageBubbleAvatarStyle : outgoingMessageBubbleAvatarStyle);
                    bindThreadView(threadView, message, null, messageBubbleAlignment, isIncomingMessage ? incomingMessageBubbleThreadIndicatorTextColor : outgoingMessageBubbleThreadIndicatorTextColor, isIncomingMessage ? incomingMessageBubbleThreadIndicatorTextAppearance : outgoingMessageBubbleThreadIndicatorTextAppearance, isIncomingMessage ? incomingMessageBubbleThreadIndicatorIconTint : outgoingMessageBubbleThreadIndicatorIconTint, 0);
                    break;
            }
        } else {
            if (isIncomingMessage) {
                setMessageBubbleStyle(incomingDeleteBubbleBackgroundColor, incomingDeleteBubbleCornerRadius, incomingDeleteBubbleStrokeWidth, incomingDeleteBubbleStrokeColor, incomingDeleteBubbleBackgroundDrawable, cometchatMessageBubble);
                bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), incomingDeleteBubbleSenderNameTextColor, incomingDeleteBubbleSenderNameTextAppearance, incomingDeleteBubbleDateStyle);
                bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), 0, incomingDeleteBubbleDateStyle);
                ...
                setMessageBubbleStyle(outgoingDeleteBubbleBackgroundColor, outgoingDeleteBubbleCornerRadius, outgoingDeleteBubbleStrokeWidth, outgoingDeleteBubbleStrokeColor, outgoingDeleteBubbleBackgroundDrawable, cometchatMessageBubble);
                bindHeaderView(headerView, !hideName, message.getSender().getName(), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.TOP), outgoingDeleteBubbleSenderNameTextColor, outgoingDeleteBubbleSenderNameTextAppearance, outgoingDeleteBubbleDateStyle);
                bindStatusInfoView(statusInfoView, showReadReceipt, MessageReceiptUtils.MessageReceipt(message), getDatePattern(message), timeStampAlignment.equals(UIKitConstants.TimeStampAlignment.BOTTOM), 0, outgoingDeleteBubbleDateStyle);
     ...
     *                               applied.
     */
    private void setMessageBubbleStyle(@ColorInt int backgroundColor, int cornerRadius, int strokeWidth, @ColorInt int strokeColor, Drawable backgroundDrawable, CometChatMessageBubble cometchatMessageBubble) {
    ...
    private boolean isHideName(BaseMessage baseMessage, UIKitConstants.MessageBubbleAlignment alignment) {
        ...
        if (listAlignment.equals(UIKitConstants.MessageListAlignment.STANDARD) && (alignment.equals(UIKitConstants.MessageBubbleAlignment.LEFT) || alignment.equals(UIKitConstants.MessageBubbleAlignment.RIGHT)) && baseMessage.getReceiverType().equals(CometChatConstants.RECEIVER_TYPE_GROUP)) {
            hideName = false;
        } else hideName = !listAlignment.equals(UIKitConstants.MessageListAlignment.LEFT_ALIGNED);
        return hideName;
    }

    private CometChatMessageTemplate clonedTemplate(CometChatMessageTemplate template, BaseMessage baseMessage, UIKitConstants.MessageBubbleAlignment alignment, int position, RecyclerView.ViewHolder viewHolder, String time, boolean hideName, boolean showReadReceipt) {
    ...
    public CometChatMessageBubble getMessageBubble(BaseMessage baseMessage, CometChatMessageTemplate template, UIKitConstants.MessageBubbleAlignment alignment, RecyclerView.ViewHolder holder, int position, String time, boolean hideName, boolean showReadReceipt) {
    ...
    public void setIncomingMessageBubbleStyle(@StyleRes int messageBubbleStyle) {
        if (messageBubbleStyle != 0) {
            ...
            try {
                setIncomingMessageBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleBackgroundColor, 0));
                ...
                setIncomingMessageBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleThreadIndicatorTextColor, 0));
                setIncomingMessageBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleThreadIndicatorIconTint, 0));
                ...
                setIncomingMessageBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleSenderNameTextColor, 0));
    ...
    public void setOutgoingMessageBubbleStyle(@StyleRes int messageBubbleStyle) {
        if (messageBubbleStyle != 0) {
            TypedArray typedArray = context.obtainStyledAttributes(messageBubbleStyle, R.styleable.CometChatMessageBubble);
            try {
                setOutgoingMessageBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleBackgroundColor, com.cometchat.chatuikit.CometChatTheme.getPrimaryColor(context)));
                setOutgoingMessageBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatMessageBubble_cometchatMessageBubbleCornerRadius, 0));
                setOutgoingMessageBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatMessageBubble_cometchatMessageBubbleStrokeWidth, 0));
                ...
                setOutgoingMessageBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatMessageBubble_cometchatMessageBubbleMessageReceiptStyle, 0));
                setOutgoingMessageBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatMessageBubble_cometchatMessageBubbleAvatarStyle, 0));
                setOutgoingMessageBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatMessageBubble_cometchatMessageBubbleThreadIndicatorTextAppearance, 0));
                setOutgoingMessageBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleThreadIndicatorTextColor, 0));
                setOutgoingMessageBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleThreadIndicatorIconTint, 0));
                setOutgoingMessageBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatMessageBubble_cometchatMessageBubbleSenderNameTextAppearance, 0));
                setOutgoingMessageBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatMessageBubble_cometchatMessageBubbleSenderNameTextColor, 0));
                ...
                setOutgoingCollaborativeBubbleStyle(typedArray.getResourceId(R.styleable.CometChatMessageBubble_cometchatCollaborativeBubbleStyle, 0));
    ...
    public void setIncomingDeleteBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingDeleteBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingDeleteBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingDeleteBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingDeleteBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingDeleteBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingDeleteBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingDeleteBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingDeleteBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setOutgoingDeleteBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatDeleteBubble);
        try {
            setOutgoingDeleteBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingDeleteBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingDeleteBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingDeleteBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingDeleteBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingDeleteBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingDeleteBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingDeleteBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatDeleteBubble_cometchatDeleteBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setOutgoingTextBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatTextBubble);
        try {
            setOutgoingTextBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatTextBubble_cometchatTextBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingTextBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatTextBubble_cometchatTextBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingTextBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatTextBubble_cometchatTextBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingTextBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatTextBubble_cometchatTextBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingTextBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatTextBubble_cometchatTextBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingTextBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatTextBubble_cometchatTextBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingTextBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatTextBubble_cometchatTextBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingTextBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatTextBubble_cometchatTextBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingTextBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatTextBubble_cometchatTextBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setOutgoingTextBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatTextBubble_cometchatTextBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorTextColor));
            setOutgoingTextBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatTextBubble_cometchatTextBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setOutgoingTextBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatTextBubble_cometchatTextBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingImageBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingImageBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingImageBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatImageBubble_cometchatImageBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingImageBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatImageBubble_cometchatImageBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingImageBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingImageBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingImageBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingImageBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingImageBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingImageBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingImageBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingImageBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingImageBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
    ...
    public void setOutgoingImageBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatImageBubble);
        try {
            setOutgoingImageBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingImageBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatImageBubble_cometchatImageBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingImageBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatImageBubble_cometchatImageBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingImageBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingImageBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingImageBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingImageBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingImageBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingImageBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingImageBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingImageBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatImageBubble_cometchatImageBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingImageBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatImageBubble_cometchatImageBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingVideoBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingVideoBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingVideoBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatVideoBubble_cometchatVideoBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingVideoBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatVideoBubble_cometchatVideoBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingVideoBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingVideoBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingVideoBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingVideoBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingVideoBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingVideoBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingVideoBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingVideoBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingVideoBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
    ...
    public void setOutgoingVideoBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatVideoBubble);
        try {
            setOutgoingVideoBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingVideoBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatVideoBubble_cometchatVideoBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingVideoBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatVideoBubble_cometchatVideoBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingVideoBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingVideoBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingVideoBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingVideoBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingVideoBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingVideoBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingVideoBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingVideoBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatVideoBubble_cometchatVideoBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingVideoBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatVideoBubble_cometchatVideoBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
    ...
    public void setIncomingFileBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingFileBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingFileBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatFileBubble_cometchatFileBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingFileBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatFileBubble_cometchatFileBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingFileBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingFileBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingFileBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingFileBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingFileBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingFileBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingFileBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingFileBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingFileBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
    ...
    public void setOutgoingFileBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatFileBubble);
        try {
            setOutgoingFileBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingFileBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatFileBubble_cometchatFileBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingFileBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatFileBubble_cometchatFileBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingFileBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingFileBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingFileBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingFileBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingFileBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingFileBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingFileBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingFileBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatFileBubble_cometchatFileBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingFileBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatFileBubble_cometchatFileBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingAudioBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingAudioBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingAudioBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingAudioBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingAudioBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingAudioBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingAudioBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingAudioBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingAudioBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingAudioBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingAudioBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingAudioBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingAudioBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
    ...
    public void setOutgoingAudioBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatAudioBubble);
        try {
            setOutgoingAudioBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingAudioBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingAudioBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingAudioBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingAudioBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingAudioBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingAudioBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingAudioBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingAudioBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingAudioBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingAudioBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatAudioBubble_cometchatAudioBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingAudioBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatAudioBubble_cometchatAudioBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingPollBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingPollBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingPollBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatPollBubble_cometchatPollBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingPollBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatPollBubble_cometchatPollBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingPollBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingPollBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingPollBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingPollBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingPollBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingPollBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingPollBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingPollBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingPollBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingPollBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatPollBubble);
        try {
            setOutgoingPollBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingPollBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatPollBubble_cometchatPollBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingPollBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatPollBubble_cometchatPollBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingPollBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingPollBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingPollBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingPollBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingPollBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingPollBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingPollBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingPollBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatPollBubble_cometchatPollBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingPollBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatPollBubble_cometchatPollBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingStickerBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingStickerBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleBackgroundColor, Color.TRANSPARENT));
            setIncomingStickerBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatStickerBubble_cometchatStickerBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingStickerBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatStickerBubble_cometchatStickerBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingStickerBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingStickerBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingStickerBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingStickerBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingStickerBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingStickerBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingStickerBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingStickerBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingStickerBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingStickerBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatStickerBubble);
        try {
            setOutgoingStickerBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleBackgroundColor, Color.TRANSPARENT));
            setOutgoingStickerBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatStickerBubble_cometchatStickerBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingStickerBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatStickerBubble_cometchatStickerBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingStickerBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingStickerBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingStickerBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingStickerBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingStickerBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingStickerBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingStickerBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingStickerBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatStickerBubble_cometchatStickerBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingStickerBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatStickerBubble_cometchatStickerBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingCollaborativeBubbleStyle(@StyleRes int style) {
        ...
        try {
            setOutgoingCollaborativeBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingCollaborativeBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingCollaborativeBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingCollaborativeBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingCollaborativeBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingCollaborativeBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingCollaborativeBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingCollaborativeBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingCollaborativeBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingCollaborativeBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingCollaborativeBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingCollaborativeBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setIncomingCollaborativeBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatCollaborativeBubble);
        try {
            setIncomingCollaborativeBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingCollaborativeBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingCollaborativeBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingCollaborativeBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingCollaborativeBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingCollaborativeBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingCollaborativeBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingCollaborativeBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingCollaborativeBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingCollaborativeBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingCollaborativeBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingCollaborativeBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatCollaborativeBubble_cometchatCollaborativeBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
    }
    ...
    public void setIncomingFormBubbleStyle(@StyleRes int formBubbleStyle) {
        ...
        try {
            setIncomingFormBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingFormBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatFormBubble_cometchatFormBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingFormBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatFormBubble_cometchatFormBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingFormBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingFormBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingFormBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingFormBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingFormBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingFormBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingFormBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingFormBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingFormBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingFormBubbleStyle(@StyleRes int formBubbleStyle) {
        TypedArray typedArray = context.obtainStyledAttributes(formBubbleStyle, R.styleable.CometChatFormBubble);
        try {
            setOutgoingFormBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingFormBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatFormBubble_cometchatFormBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingFormBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatFormBubble_cometchatFormBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingFormBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingFormBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingFormBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingFormBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingFormBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingFormBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingFormBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingFormBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatFormBubble_cometchatFormBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingFormBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatFormBubble_cometchatFormBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingSchedulerBubbleStyle(@StyleRes int schedulerBubbleStyle) {
        ...
        try {
            setIncomingSchedulerBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingSchedulerBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingSchedulerBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingSchedulerBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingSchedulerBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleDateStyle, incomingMessageBubbleDateStyle));
            setIncomingSchedulerBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleMessageReceiptStyle, incomingMessageBubbleReceiptStyle));
            setIncomingSchedulerBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingSchedulerBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingSchedulerBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingSchedulerBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingSchedulerBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingSchedulerBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingSchedulerBubbleStyle(@StyleRes int schedulerBubbleStyle) {
        TypedArray typedArray = context.obtainStyledAttributes(schedulerBubbleStyle, R.styleable.CometChatSchedulerBubble);
        try {
            setOutgoingSchedulerBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingSchedulerBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingSchedulerBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingSchedulerBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingSchedulerBubbleDateStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleDateStyle, outgoingMessageBubbleDateStyle));
            setOutgoingSchedulerBubbleReceiptStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleMessageReceiptStyle, outgoingMessageBubbleReceiptStyle));
            setOutgoingSchedulerBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingSchedulerBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingSchedulerBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingSchedulerBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingSchedulerBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingSchedulerBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatSchedulerBubble_cometchatSchedulerBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setIncomingMeetCallBubbleStyle(@StyleRes int style) {
        ...
        try {
            setIncomingMeetCallBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleBackgroundColor, incomingMessageBubbleBackgroundColor));
            setIncomingMeetCallBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleCornerRadius, incomingMessageBubbleCornerRadius));
            setIncomingMeetCallBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleStrokeWidth, incomingMessageBubbleStrokeWidth));
            setIncomingMeetCallBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleStrokeColor, incomingMessageBubbleStrokeColor));
            ...
            setIncomingMeetCallBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleAvatarStyle, incomingMessageBubbleAvatarStyle));
            setIncomingMeetCallBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorTextAppearance, incomingMessageBubbleThreadIndicatorTextAppearance));
            setIncomingMeetCallBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorTextColor, incomingMessageBubbleThreadIndicatorTextColor));
            setIncomingMeetCallBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorIconTint, incomingMessageBubbleThreadIndicatorIconTint));
            setIncomingMeetCallBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleSenderNameTextAppearance, incomingMessageBubbleSenderNameTextAppearance));
            setIncomingMeetCallBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleSenderNameTextColor, incomingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public void setOutgoingMeetCallBubbleStyle(@StyleRes int style) {
        TypedArray typedArray = context.obtainStyledAttributes(style, R.styleable.CometChatMeetCallBubble);
        try {
            setOutgoingMeetCallBubbleBackgroundColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleBackgroundColor, outgoingMessageBubbleBackgroundColor));
            setOutgoingMeetCallBubbleCornerRadius(typedArray.getDimensionPixelSize(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleCornerRadius, outgoingMessageBubbleCornerRadius));
            setOutgoingMeetCallBubbleStrokeWidth(typedArray.getDimensionPixelSize(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleStrokeWidth, outgoingMessageBubbleStrokeWidth));
            setOutgoingMeetCallBubbleStrokeColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleStrokeColor, outgoingMessageBubbleStrokeColor));
            ...
            setOutgoingMeetCallBubbleAvatarStyle(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleAvatarStyle, outgoingMessageBubbleAvatarStyle));
            setOutgoingMeetCallBubbleThreadIndicatorTextAppearance(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorTextAppearance, outgoingMessageBubbleThreadIndicatorTextAppearance));
            setOutgoingMeetCallBubbleThreadIndicatorTextColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorTextColor, outgoingMessageBubbleThreadIndicatorTextColor));
            setOutgoingMeetCallBubbleThreadIndicatorIconTint(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleThreadIndicatorIconTint, outgoingMessageBubbleThreadIndicatorIconTint));
            setOutgoingMeetCallBubbleSenderNameTextAppearance(typedArray.getResourceId(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleSenderNameTextAppearance, outgoingMessageBubbleSenderNameTextAppearance));
            setOutgoingMeetCallBubbleSenderNameTextColor(typedArray.getColor(R.styleable.CometChatMeetCallBubble_cometchatMeetCallBubbleSenderNameTextColor, outgoingMessageBubbleSenderNameTextColor));
        } finally {
            typedArray.recycle();
        }
        notifyDataSetChanged();
    ...
    public interface OnMessageLongClick {
        void onLongClick(List<CometChatMessageOption> list, BaseMessage message, CometChatMessageTemplate cometchatMessageTemplate, CometChatMessageBubble cometchatMessageBubble);
    }
     ...
     */
    private void adjustFooterAndContentView(View footerView, View contentView, CometChatMessageBubble cometchatMessageBubble, BaseMessage baseMessage, @StyleRes int reactionStyle, CometChatUIKitReactionActionEvents reactionEvents) {
        if (footerView != null) {
            int reactionLimit = 4;
